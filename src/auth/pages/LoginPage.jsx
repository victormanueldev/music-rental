  ...
  return (
    <AuthLayout>
      <div className="relative -mt-16 block">
        <h2 className="mt-2 text-2xl font-bold text-gray-700 sm:text-3xl md:text-4xl">Sign In</h2>
        <p className="mt-4 leading-relaxed text-gray-500">
          Enter your credentials and get into the site
        </p>
      </div>
      <form className="mt-8 grid grid-cols-6 gap-6" onSubmit={(event) => handleSubmit(event)}>
        ...
        <div className="col-span-12 sm:flex sm:items-center sm:gap-4">
          ...
          <p className="mt-4 text-sm text-gray-500 sm:mt-0">
            ...
            <Link to="/auth/register">
              <a className="text-gray-700 underline">Create one</a>.
            </Link>
          </p>
        </div>
      </form>
